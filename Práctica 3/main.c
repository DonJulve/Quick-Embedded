...
enum {INICIAL, P0, P1, P2, P0_S_P1, P0_S_P2,  P1_S_P2, P2_B_P1, P1_B_P0, P2_B_P0} estado ;  // Definir los estados del ascensor
...
while (1)
{
    ...
    case INICIAL:
        ...
        if (Entrada & FCB) {estado = P0; Orden_Ascensor = PARAR;}
        break;
