...
int main(void)
{
    ...
    while(1)
    {
        ...
        Centesimas = (t_reaccion % 100) / 10;
        Decimas = (t_reaccion % 1000) / 100;
        Segundos = (t_reaccion % 10000) / 1000;

        switch(disp){
        case 0 : display (disp, Centesimas); break;
        case 1 : display (disp, Decimas); break;
        case 2 : display (disp, Segundos);
        }
